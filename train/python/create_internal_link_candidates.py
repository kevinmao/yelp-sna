...
def load_ub_graph(inputFile):
    ...
    with open(inputFile) as fin:
        for line in fin:
            ...
            ub_edge_set.add(e)
            ub_edge_dict[business_id].append(e)
    return user_set,business_set,ub_edge_set,ub_edge_dict      
...
def main(args):
    ...
    user_set,business_set,ub_edge_set,ub_edge_dict = load_ub_graph(ub_review_train_edges_file)
