...
## corpus data 
export DATA_ROOT=${PROJECT_HOME}/data
...
export HDFS_YELP_DATA_TSV=${HDFS_PRJ_HOME}/data/tsv
export HDFS_TRAIN_DATA=${HDFS_PRJ_HOME}/data/train
export HDFS_TEST_DATA=${HDFS_PRJ_HOME}/data/test
